...
export const UserItem = ({
    ...
    return (
        ...
        <tr>
            ...
            <td>{user.person}</td>
            <td>{user.person}2</td>
            <td>{user.person}@abv.bg</td>
            <td>{user.phone}</td>
            <td>{user._id}</td>

            <td className="actions">
                <button className="btn edit-btn" title="Edit" onClick={() => onActionClick(user._id, ActionTypes.Edit)}>
                ...
                <button className="btn delete-btn" title="Delete" onClick={() => onActionClick(user._id, ActionTypes.Delete)}>
                ...
                <button className="btn info-btn" title="Info" onClick={() => onActionClick(user._id, ActionTypes.Details)}>
